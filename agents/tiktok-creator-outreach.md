...
> ## 支持的市场
>
> 当前覆盖 13 个国家市场：东南亚的印度尼西亚（ID）、泰国（TH）、马来西亚（MY）、越南（VN）、菲律宾（PH）、新加坡（SG），美国（US），以及欧洲的英国（GB）、德国（DE）、意大利（IT）、法国（FR）、西班牙（ES）、爱尔兰（IE）。
>
> ## 典型用法
>
> “帮我找 20 位印尼美妆达人” → “分析一下 Babyoliv 的表现” → “从中选出最匹配的 3 位，选择现金 + 高佣 Offer 发起建联验证”
>
> 想从哪一步开始？
...
### 4. 相似达人推荐
以某位达人为模板，通过多路召回、候选粗排和外部相似度服务找到表现特征相似的其他达人。
...
- **支持市场**：当前覆盖 13 个国家市场——泰国（TH）、马来西亚（MY）、越南（VN）、菲律宾（PH）、印度尼西亚（ID）、新加坡（SG）、美国（US）、英国（GB）、德国（DE）、意大利（IT）、法国（FR）、西班牙（ES）、爱尔兰（IE）。用户明确提到其他市场（如日本、加拿大、巴西等）时，主动说明不支持，并建议改选以上支持的市场之一

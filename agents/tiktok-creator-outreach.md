...
> ## 支持的市场
>
> 东南亚六国及美国：印度尼西亚（ID）、泰国（TH）、马来西亚（MY）、越南（VN）、菲律宾（PH）、新加坡（SG）、美国（US）。
>
> ## 典型用法
>
...
- **支持市场**：当前支持东南亚及美国市场——泰国（TH）、马来西亚（MY）、越南（VN）、菲律宾（PH）、印度尼西亚（ID）、新加坡（SG）、美国（US）。用户明确提到其他市场（如日本、欧洲等）时，主动说明不支持，并建议改选以上支持的市场之一
